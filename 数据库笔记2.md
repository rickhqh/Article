...
#    ![](media/image1.jpeg){width="4.541666666666667in" height="2.4791666666666665in"}
...
#### E-R图
 ...
 ![](media/image2.jpeg){width="3.3645833333333335in" height="3.3958333333333335in"}

#### 逻辑模型和物理模型：

1.     ![](media/image3.jpeg){width="4.833333333333333in" height="1.96875in"}层次模型（树）

2.     网状模型（数据结构的图）

3.     ![](media/image4.jpeg){width="2.2395833333333335in" height="3.1875in"}**关系模型**（表）

  ![](media/image5.jpeg){width="2.291667760279965in" height="1.9375in"}
...
###    ![](media/image6.jpeg){width="4.885415573053368in" height="3.6458333333333335in"}4.三级模式两级映像

 ![](media/image7.jpeg){width="2.3020833333333335in" height="3.6041666666666665in"}

   ![](media/image8.jpeg){width="2.21875in" height="0.71875in"}
...
1. **集合运算**：并、交、差、笛卡尔积
   ...
   ![](media/image10.jpeg){width="6.179656605424322in" height="3.1186450131233596in"}   ![](media/image11.jpeg){width="5.67759186351706in" height="2.49375in"}

2. **选择**：选择符合条件的元组

 ![](media/image12.jpeg){width="4.562498906386701in" height="1.7916666666666667in"}

   ![](media/image13.jpeg){width="3.1666655730533684in" height="1.2708333333333333in"}

选择可能会涉及的运算符：

   ![](media/image14.jpeg){width="3.4791666666666665in" height="2.96875in"}

2.  投影：选择某一列

 ![](media/image15.jpeg){width="2.5520833333333335in" height="2.0833333333333335in"}

   ![](media/image16.jpeg){width="1.7604155730533684in" height="1.65625in"}
...
4. **除**：
   ...
   ![](media/image17.jpeg){width="4.5625in" height="2.6145833333333335in"}   ![](media/image18.jpeg){width="3.958332239720035in" height="3.2916666666666665in"}   ![](media/image19.jpeg){width="4.625in" height="0.8645833333333334in"}
...
#### 数据定义:CREATE DROP ALTER
 ...
 ![](media/image21.jpeg){width="6.1621314523184605in" height="1.6314577865266842in"}



模式的定义删除：

   ![](media/image22.jpeg){width="5.890738188976378in" height="2.73in"}

 基本表的定义、删除、修改：

 ![](media/image23.jpeg){width="3.5729166666666665in" height="2.3333333333333335in"}

   ![](media/image24.jpeg){width="6.1761614173228345in" height="2.0934372265966754in"}   ![](media/image25.png){width="6.125709755030621in" height="4.96875in"}

 ![](media/image26.jpeg){width="5.591897419072616in" height="2.153124453193351in"}

索引的建立和删除：

   ![](media/image27.jpeg){width="4.416665573053368in" height="3.1770833333333335in"}

#### 数据查询：SELECT

（1）基本的查询、带通配符\*查询、带表达式（2014-age）查询、列重命名查询、字符变小写查询、去重查询

   ![](media/image28.jpeg){width="6.039406167979003in" height="2.05in"}   ![](media/image29.jpeg){width="4.5625in" height="1.21875in"}

 ![](media/image30.jpeg){width="5.843767497812774in" height="1.40625in"}

   ![](media/image31.jpeg){width="1.9374989063867016in" height="1.9375in"}

2.  条件查询（简单条件、like模糊匹配字符、转义后匹配、多条件查询）：

 ![](media/image32.jpeg){width="4.697915573053368in" height="2.3020833333333335in"}
   ...
   ![](media/image36.jpeg){width="6.173406605424322in" height="0.7984372265966754in"}
...
5. 聚合函数
    ...
    ![](media/image41.jpeg){width="6.173485345581803in" height="2.8in"}
...
SELECT \* FROM A,B 实际上进行的是笛卡尔积运算
   ...
   ![](media/image44.jpeg){width="5.7414085739282585in" height="3.334374453193351in"}有意义的是进行等值连接
...
7.  嵌套查询
 ...
 ![](media/image47.jpeg){width="5.2395877077865265in" height="3.9375in"}
...
删除
 ...
 ![](media/image52.jpeg){width="3.562498906386702in" height="1.125in"}
...
保留了主码的视图叫做**行列子集视图**，这类视图一定是可以更新的创建视图：
   ...
   ![](media/image53.jpeg){width="6.193139763779527in" height="3.3328116797900265in"}
...
级联收回
 ...
 ![](media/image62.jpeg){width="6.128693132108486in" height="2.8925in"}
   ...
   ![](media/image63.jpeg){width="6.0146773840769905in" height="0.680832239720035in"}
...
例子：
   ...
   ![](media/image71.jpeg){width="6.200115923009624in" height="3.035416666666667in"}   ![](media/image72.jpeg){width="5.490767716535433in" height="2.533228346456693in"}
...
考题，求出下列F的候选码
   ...
   ![](media/image81.jpeg){width="6.112790901137358in" height="3.4598950131233597in"}
...
### 3.公理系统
   ...
   ![](media/image90.jpeg){width="5.120993000874891in" height="3.375in"}
 ...
 ![](media/image91.jpeg){width="5.427082239720035in" height="3.5833333333333335in"}
   ...
   ![](media/image93.jpeg){width="6.148159448818897in" height="2.875in"}

##  第七章

   ![](media/image94.jpeg){width="6.23649387576553in" height="4.68in"}

 ![](media/image95.jpeg){width="4.104166666666667in" height="2.46875in"}
...
#### (3).逻辑结构设计
 ...
 ![](media/image103.jpeg){width="4.916666666666667in" height="3.84375in"}
...
![](media/image107.jpeg){width="2.2916655730533684in" height="1.5in"} 
...
### 2.过程SQL
 ...
 ![](media/image110.jpeg){width="2.3854155730533684in" height="2.8854166666666665in"}
...
##  第九章 
 ...
 ![](media/image112.jpeg){width="4.302082239720035in" height="1.5in"}

###  1.查询处理

查询过程：

   ![](media/image113.jpeg){width="3.03125in" height="3.5104166666666665in"}
...
代数优化的规则
   ...
   ![](media/image114.jpeg){width="5.204106517935258in" height="2.4514577865266842in"}
...
重装数据库，重做已经完成的事务
 ...
 ![](media/image117.jpeg){width="5.874998906386701in" height="3.3958333333333335in"}

###    ![](media/image118.jpeg){width="5.479166666666667in" height="2.5729166666666665in"}   ![](media/image119.jpeg){width="2.3541666666666665in" height="2.71875in"}   ![](media/image120.jpeg){width="1.4687489063867016in" height="0.875in"}
